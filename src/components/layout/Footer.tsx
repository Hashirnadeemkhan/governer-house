...
const Footer = () => {
  return (
    <section className="bg-[#f4f4f5]">
      <Wrapper>
        <div className="flex flex-col lg:flex-row py-20 text-sm">
          {/* coure courses */}
          <div className="flex-1 space-y-5">
            <h4 className=" font-semibold text-xl mt-8">Core Courses</h4>
            <ul className="space-y-3 gap-y-5">
          ...
          {/* advance courses */}
          <div className="flex-1 space-y-5 mt-8">
            <h4 className="font-semibold text-xl">Advanced Courses</h4>
          ...
          <div className="flex-1 mt-8">
            <h4 className="font-semibold text-xl">Social Links</h4>
            <div className="flex gap-x-4 mt-4">
              ...
              <a
                target="_blank"
                className="instagram flex h-8 w-8 items-center justify-center rounded-full text-white bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600"
